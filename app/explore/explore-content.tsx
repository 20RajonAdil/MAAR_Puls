...
import { Music2, Gamepad2, Cpu, GraduationCap, Newspaper, Trophy, Clapperboard, FlaskConical, Leaf, Moon, Flame } from 'lucide-react';
...
const CATEGORIES = [
  ...
  { label: 'Music', icon: Music2, query: { kind: 'category' as const, id: '10' } },
  ...
  { label: 'Entertainment', icon: Clapperboard, query: { kind: 'category' as const, id: '24' } },
