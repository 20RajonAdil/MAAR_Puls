...
/**
 * Fetches from /api/youtube/playlists, mirroring hooks/use-videos.ts so
 * the Playlists tab shares the same loading/error/pagination contract as
 * every other tab on the channel page.
 */
export function usePlaylists(url: string | null) {
